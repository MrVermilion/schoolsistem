...
echo '<h3 class="custom-text">CONSULTA DE PROFESSOR</h3>';
...
$htmlTabelaProfessores .= "<button class='button' type='button' onclick='abreCadastroInclusao()'><a href='professor.php'>Incluir - PHP</a><button>";
